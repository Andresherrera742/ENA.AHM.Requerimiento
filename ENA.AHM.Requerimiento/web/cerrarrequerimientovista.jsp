                ...
                <div class="card shadow w-100 mx-auto" >
                    ...
                    <div class="card-body">	
                        ...
                        <td>
                            ...
                            <a href="requerimientoController.do?action=listarcerrar&id=${requerimiento.requerientoId}"
                        ...
                        <div class="card-body">						                            	
                            <table class="table  table-stripper hover">
                                ...
                                <tbody>
                                    <c:forEach var="requerimientos" items="${requerimiento}">                                
                                        <tr>    
                                            ...
                                            <td>
                                                <a href="requerimientoController.do?action=cerrar&id=${requerimiento.requerimientoId}"
